...
const translations = {
  en: {
    ...
    webDesignSub: "The most modern and high-quality design made at a professional level.",
    webDevelopment: "Web development",
    webDevelopmentSub: "High-quality development of sites at the professional level.",
    mobileApps: "Mobile apps",
    mobileAppsSub: "Professional development of applications for Android.",
    photography: "Photography",
    photographySub: "I make high-quality photos of any category at a professional level.",
    education: "Education",
    university: "Shamsipour technical and Vocational College (STVC)",
    university_date: "2024 — Present",
    university_text: "I am studying software and acquiring more technical sciences in this field.",
    highSchool: "High school of Network and software",
    highSchool_date: "2021 - 2024",
    highSchool_text: "Gaining knowledge and experience in computer science and computer networks and doing several practical and internship projects.",
  ...
  fa: {
    ...
    webDesign: "طراحی وب",
    webDesignSub: "مدرن‌ترین و باکیفیت‌ترین طراحی که در سطح حرفه‌ای ساخته شده است.",
    webDevelopment: "توسعه وب",
    webDevelopmentSub: "توسعه سایت‌ها با کیفیت بالا در سطح حرفه‌ای.",
    mobileApps: "برنامه‌های موبایل",
    mobileAppsSub: "توسعه حرفه‌ای اپلیکیشن برای اندروید",
    photography: "عکاسی",
    photographySub: "من عکس‌های باکیفیتی از هر دسته‌بندی در سطح حرفه‌ای می‌گیرم.",
    education: "تحصیلات",
    university: "دانشکده ملی مهارت شهید شمسی پور",
    university_date: "۱۴۰۳ - اکنون",
    university_text: "من در حال تحصیل در رشته نرم‌افزار و کسب علوم فنی بیشتر در این زمینه هستم.",
    highSchool: "هنرستان فنی حرفه ای  (رشته شبکه و نرم افزار)",
    highSchool_date: "۱۴۰۰ - ۱۴۰۲",
    highSchool_text: "کسب دانش و تجربه در علوم کامپیوتر و شبکه‌های کامپیوتری و انجام چندین پروژه عملی و کارآموزی.",
    experience: "تجربیات",
